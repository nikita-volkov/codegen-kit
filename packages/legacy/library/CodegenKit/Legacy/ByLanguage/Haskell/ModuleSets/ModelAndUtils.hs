module CodegenKit.Legacy.ByLanguage.Haskell.ModuleSets.ModelAndUtils
  ( -- * --
    modules,
...
import CodegenKit.Legacy.ByLanguage.Haskell.ModuleSets.ModelAccessors qualified as ModelAccessorsPackage
...
import CodegenKit.Legacy.Prelude hiding (Product, Sum, product, sum)
